...
def main():
    ...
    ap.add_argument("--ckpt_2cls", type=str, default="./checkpoints/darknet19_best_20251208-095428.pth")
    ap.add_argument("--ckpt_4cls", type=str, default="./checkpoints/darknet19_hier_best_20251208-095809.pth")
