...
# ========== MAML Network (DarkNet-19, 4cls) ==========
MAML_DATA_ROOT = DATASET_STFT
MAML_N_WAY = 4
MAML_N_SUPPORT = 5
MAML_N_QUERY = 15
MAML_EPOCHS = 100
MAML_TRAIN_EPISODES = 120
MAML_VAL_EPISODES = 60
MAML_TEST_EPISODES = 100
MAML_META_BATCH = 4
MAML_LR = 1e-3
MAML_WEIGHT_DECAY = 0.0
MAML_INNER_STEPS = 5
MAML_INNER_ENCODER_LR = 0.01
MAML_INNER_CLASSIFIER_LR = 0.01
MAML_INNER_MOMENTUM = 0.0
MAML_INNER_WEIGHT_DECAY = 0.0
MAML_FIRST_ORDER = 0
