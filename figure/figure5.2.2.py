...
# 1. 读入并整理数据
df = pd.read_excel("figure/figure5.2.2.xlsx")
...
base_colors = ['#F0C808', '#DD8452', '#8172B2',
               "#DA4A4A", "#2B5F37", "#6B96DB"]
...
ax.set_xticklabels(['Macro-F1', 'Macro-Recall'], fontweight='bold')
...
plt.tight_layout()
plt.savefig("figure/figure5.2.2_python.png", bbox_inches='tight', dpi=600, transparent=True)
plt.savefig("figure/figure5.2.2_python.svg", bbox_inches='tight')
plt.show()
