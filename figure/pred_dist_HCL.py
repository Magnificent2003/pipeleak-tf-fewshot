...
def plot_quadrant_scatter(x, y, y_true,
    ...
    # 副刻度：如果还想保留，可以继续用 minor locator；
    # 只是不再画任何网格线
    ...
    ax.text(0.75, 0.30, "Seepage leak", fontsize=9,
            ha="center", va="center")
    ax.text(-0.75, 0.30, "Valve leak", fontsize=9,
            ha="center", va="center")
    ax.text(-0.60, -0.60, "Normal non-leak", fontsize=9,
            ha="center", va="center")
    ax.text(0.60, -0.60, "Non-leak with impulsive", fontsize=9,
            ha="center", va="center")
    ...
    ax.set_title("Prediction distribution (with HCL)",
                 fontsize=11)
...
def main():
    ...
    ap.add_argument("--out", type=str, default="./figure/pred_dist_HCL.svg")
    ap.add_argument("--outpng", type=str, default="./figure/pred_dist_HCL.png")
    # 可以在命令行微调灵敏度 & 抖动
